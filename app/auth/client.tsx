...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your PulseCRM account",
        description: "Start using your new CRM experience in under a minute.",
      };
    }

    return {
      id: "signin",
      title: "Sign in to PulseCRM",
      description: "Access your CRM workspace for your startup.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Manage your leads, deals, and team in one place.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Secure sign in, beautiful CRM interface, and onboarding for modern startup teams.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-secondary/70 bg-background/80 p-3 shadow-lg">
              <Image
                src="/demo-img.jpg"
                alt="PulseCRM dashboard preview"
